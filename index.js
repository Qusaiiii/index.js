...
${prefix}queue ⇏ لمعرفة قآئمة التشغيل
 ...
 `)
  ...
  if(!message.member.hasPermission('ADMINISTRATOR')) return      message.channel.send('**للأسف لا تمتلك صلاحية لاستعمال هاذا الأمر** 
    ...
    let copy = "Frix v0.1";//By Codes , ' ّEpicEdiTeDّ#4968
...
**  الرسالة : ** ${args}
        ...
        `)//By Codes , ' ّEpicEdiTeDّ#4968
         ...
         .setFooter('Frix v0.1' , 'https://cdn.discordapp.com/avatars/465885551329804288/55614337cfb9813916a60383469736d9.jpg?size=128')
    m.send({ embed: bc })
